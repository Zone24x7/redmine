  ...
  def update
    ...
    if saved
      ...
      respond_to do |format|
        ...
        # Uses a custom method implemented to wrap exceptions by rendering the issues new status without redirecting twice
        format.html { redirect_back_wrapper issue_path(@issue)}
